...
import { UNIQUE_COUNTRIES, JOB_TYPES } from "../data";
...
export function SearchBar({
  ...
  return (
    <div className="bg-white border-b border-[#E5E7EB]">
      <div className="max-w-[1340px] mx-auto px-6 h-[60px] flex items-center gap-3">
        {/* Search input + tags */}
        ...
        <div className="h-7 w-px bg-[#E5E7EB] shrink-0" />
        ...
        <div className="flex items-center gap-0.5 shrink-0">
          ...
          <button className="flex items-center gap-[6px] text-[12.5px] text-[#374151] font-medium px-3 py-2 rounded-lg hover:bg-[#F3F4F6] transition-colors">
            <DollarSign className="w-[13px] h-[13px] text-[#9CA3AF]" />
            <span>Salary Range</span>
            <ChevronDown className="w-[13px] h-[13px] text-[#9CA3AF]" />
          </button>
        </div>

        <button className="bg-primary hover:bg-primary/90 text-white text-[12px] font-bold tracking-[0.04em] px-5 py-2.5 rounded-lg transition-colors shrink-0 uppercase">
          Start Searching
        </button>
      </div>
    </div>
